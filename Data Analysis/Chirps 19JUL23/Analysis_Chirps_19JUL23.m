...
% --Call on analyze data function (Trial 1; Chirp 1)
    data_path = "C:\Users\FIT UBD\Desktop\Array Acoustics\Test Data\Validation Data\Testing 19JUL2023\Chirp_echo_1";
    analyze_data(data_path,32,"false",2.96,3)

% --Try a second chirp (Trial 2; Chirp 2)
    spectrogram_data(data_path,32,5.2,5.23)

% --Second data test (Trial 2; Chrip 1)
    data_path = "C:\Users\FIT UBD\Desktop\Array Acoustics\Test Data\Validation Data\Testing 19JUL2023\Chirp_echo_2";
