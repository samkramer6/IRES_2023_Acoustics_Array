...
% 
%   This is a function that will be used to filter the data that is
%   collected by the array. This filter will use a 4th order bandpass
%   butterworth to filter the background noise out of the data. This will
%   have a 15% band around the center filter frequency.
%
%   Inputs: test_data   --  The raw test data from the daq
